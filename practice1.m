...
plot(xsave1, ysave1)
outer = plot(xsave1(1),ysave1(1), '-o','MarkerFaceColor','green');
...
lgd = legend('Orbited Body','Orbit 1','Orbit 2','Spaceship','Satelite');
c = lgd.TextColor;
lgd.TextColor = 'black';

%sets background color to white (outside box to white)
set(gcf,'color','w');
%set background color to black (inside box)
set(gca,'Color','k')
